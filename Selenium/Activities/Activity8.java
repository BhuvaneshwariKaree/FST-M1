...
public class Activity8 {
    public static void main(String[] args) {
        ...
        // Perform double click on src and then right click on target
        builder.doubleClick(srcButton).pause(Duration.ofSeconds(2)).contextClick(targetButton).pause(Duration.ofSeconds(2)).perform();
        builder.click(driver.findElement(By.xpath("//span[text()='Open']"))).pause(Duration.ofSeconds(2)).pause(5000).build().perform();
